                                                        ...
                                                        <table id="tbl_data" class="table table-striped table-bordered text-nowrap table-custom">
                                                            ...
                                                            <thead>
                                                                    <tr>
                                                                            ...
                                                                            <th><? echo $adm_lang['codigo'] ?></th>  
                                                                            <th><? echo $adm_lang['activo'] ?></th>  
                                                                            <th><? echo $adm_lang['por_defecto'] ?></th>  
                                                                            <th><? echo $adm_lang['activo_backend'] ?></th>  
                                                                            <th><? echo $adm_lang['por_defecto_backend'] ?></th>  
                                                                    </tr>
                                                            </thead>
                                                            <tbody>
                                                                <? for($i = 0; $i < count($row); $i++) { ?>
                                                                    <tr>
                                                                            ...
                                                                            <td><? echo $row[$i]['codigo'] ?></td>    
                                                                            <td><? echo $options_si_no[$row[$i]['activo']] ?></td>   
                                                                            <td><? if ($row[$i]['defecto']) { ?><i class="fa fa-check"></i><? } ?></td>   
                                                                            <td><? echo $options_si_no[$row[$i]['activo_admin']] ?></td>   
                                                                            <td><? if ($row[$i]['defecto_admin']) { ?><i class="fa fa-check"></i><? } ?></td>  
                                                                    </tr>
                                                                <? } ?>    
                                                            </tbody>
