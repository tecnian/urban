                                                        ...
                                                        <table id="tbl_data" class="table table-striped table-bordered text-nowrap table-custom">
                                                            ...
                                                            <thead>
                                                                    <tr>
                                                                            ...
                                                                            <th><? echo $adm_lang['usuario'] ?></th>  
                                                                            <th><? echo $adm_lang['perfil'] ?></th>  
                                                                            <th>Email</th>  
                                                            ...
                                                            <tbody>
                                                                <? for($i = 0; $i < count($row); $i++) { ?>
                                                                    <tr>
                                                                            <td class="check"><input class="check_box" name="item_<? echo $row[$i]['id'] ?>" type="checkbox" <? if ($row[$i]['id'] == 1) { ?>disabled<? } ?>/></td>
                                                                            <td><a href="<? echo $update_page ?>&id=<? echo $row[$i]['id'] ?>"><? echo $row[$i]['nombre'] ?></a></td>      
                                                                            <td><? echo $row[$i]['usuario'] ?></td>    
                                                                            <td><? echo $options_profile[$row[$i]['id_perfil']] ?></td>  
