        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#tbl_data").dataTable({
                    //"processing": true,
                    //"serverSide": true,
                    //"ajax": "server/datalist.php?table_id=<? echo TBL::CATALOGO ?>&type=<? echo $type ?>",
                    "bStateSave": true,
                    "order": [[ 1, "asc" ]],                
                                                            ...
                                                            <tbody>
                                                                <? for($i = 0; $i < count($row); $i++) { ?>
                                                                    <tr>
                                                                            ...
                                                                            <td data-order="<? echo $row[$i]['fecha'] ?>"><a href="<? echo $update_page ?>&id=<? echo $row[$i]['id'] ?>"><? echo $row[$i]['titulo'] ?></a></td>      
